...
def main() -> int:
    ...
    db.commit()
    db.close()
    print(f"  egypt-macro.sqlite  {sqlite_path.stat().st_size/1e6:.1f} MB")
            ...
            json.dumps(
                {
                    ...
                    **{k: meta.get(k) for k in
                    ...
                    "observations": points,
                    "count": len(points),
                    "attribution": "Source: Central Bank of Egypt. Republished by Egypt Macro.",
                },
                ensure_ascii=False,
            ),
            encoding="utf-8",
