...
const PALETTE_PAGES = [
  ...
  { label: "Browse by subject", href: "#/browse", hint: "thirteen topics",
    alt: "topics subjects everything all series categories" },
  { label: "Find a series", href: "#/find", hint: "search the catalogue on its own page",
    alt: "search catalogue lookup" },
